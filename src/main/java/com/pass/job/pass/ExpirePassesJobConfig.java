...
public class ExpirePassesJobConfig {
    ...
    public Step expirePassesStep() {
        ...
        return this.stepBuilderFactory.get("expirePassesStep")
                ...
                .reader(expriePassesItemReader())
                .processor(expriePassesItemProcessor())
    ...
    @Bean
    @StepScope
    public JpaCursorItemReader<PassEntity> expriePassesItemReader() {

        return new JpaCursorItemReaderBuilder<PassEntity>()
                .name("expriePassesItemReader")
    ...
    @Bean
    public ItemProcessor<PassEntity, PassEntity> expriePassesItemProcessor() {
